...
public class InvariantExamples {
                                ...
                                public boolean filter(Event event, Context<Event> context)
                                    ...
                                    for (var specialEvent : context.getEventsForPattern("???")) {
                                        ...
                                        var affectedProductId =
                                                event.Content.get("OrderId").asInt();
                                        return affectedProductId
                                                == specialEvent.Content.get("OrderId").asInt();
                                    }
    ...
    /* Invariant for:
      ...
      WITHIN 5 min
    */
    public static Pattern<Event, ?> ExampleInvariant0 =
            Pattern.<Event>begin("E_1")
                    .where(
                            new SimpleCondition<>() {
                                @Override
    ...
    /* Invariant for:
      ...
      WITHIN 5 min
    */
    public static Pattern<Event, ?> ExampleInvariant =
            Pattern.<Event>begin("E_1")
                    .where(
                            new SimpleCondition<>() {
                                @Override
    ...
    /* Invariant for:
      ...
      WITHIN 5 min
    */
    public static Pattern<Event, ?> ExampleInvariant2 =
            Pattern.<Event>begin("E_1")
                    .where(
                            new SimpleCondition<>() {
                                @Override
    ...
    /* Invariant for:
      ...
      WITHIN 5 min
    */
    public static Pattern<Event, ?> ExampleInvariant3 =
            Pattern.<Event>begin("E_1")
                    .where(
                            new SimpleCondition<>() {
                                @Override
                            ...
                            new IterativeCondition<>() {
                                ...
                                public boolean filter(Event event, Context<Event> context)
                                    ...
                                    return e1_id.equals(e2_id)
                                            && (e2.Content.get("id")
                                                            .asText()
                                                            .equals(e3.Content.get("id").asText())
                                                    || e1.Content.get("other")
                                                            .asText()
                                                            .equals(
                                                                    e3.Content.get("other")
                                                                            .asText()));
                                }
                            })
                    .within(Time.seconds(5));
    ...
    /* Invariant for:
      ...
      WITHIN 5 sec
    */
    public static Pattern<Event, ?> ExampleInvariant4 =
            Pattern.<Event>begin("E_1")
                    .where(
                            new SimpleCondition<>() {
                                @Override
    ...
    public static Pattern<Event, ?> test =
            Pattern.<Event>begin("e_1")
                    .where(
                            new SimpleCondition<>() {
                                @Override
                    ...
                    .where(
                            new IterativeCondition<>() {
                                ...
                                public boolean filter(Event event, Context<Event> context)
                                    ...
                                    return context.getEventsForPattern("e_1")
                                                    .iterator()
                                                    .next()
                                                    .Content
                                                    .get("id")
                                                    .equals(
                                                            context.getEventsForPattern("e_2")
                                                                    .iterator()
                                                                    .next()
                                                                    .Content
                                                                    .get("id"))
                                            && context.getEventsForPattern("e_2")
                                                    ...
                                                    .get("id")
                                                    .equals(
                                                            context.getEventsForPattern("e_3")
                                                                    .iterator()
                                                                    .next()
                                                                    .Content
                                                                    .get("id"))
                                            && context.getEventsForPattern("e_1")
                                                    .iterator()
                                                    .next()
                                                    .Content
                                                    .get("id")
